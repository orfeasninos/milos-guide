...
const seedBeaches = [
  ...
  { name: "Ammoudaki",           slug: "ammoudaki",           accessType: "road", facilities: [] },
  ...
  { name: "Polonia beach",       slug: "polonia-beach",       accessType: "road", facilities: [] },
  { name: "Mandrakia",           slug: "mandrakia",           accessType: "road", facilities: [] },
  { name: "Kalogries beach",     slug: "kalogries-beach",     accessType: "road", facilities: [] },
  ...
  { name: "Kolympionas beach",   slug: "kolympionas-beach",   accessType: "road", facilities: [] },
...
const beachTranslations = {
  ...
  "ammoudaki":            { name: "Ammoudaki",           description: "A tiny remote beach reachable only on foot or by boat — pristine and rarely visited." },
  ...
  "polonia-beach":        { name: "Polonia Beach",       description: "A convenient family-friendly beach in the fishing village of Pollonia, close to cafes and tavernas." },
