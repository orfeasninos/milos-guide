...
const seedBeaches = [
  { name: "Sarakiniko",          slug: "sarakiniko",          accessType: "road", facilities: ["parking"],           sandType: "Volcanic rock", shade: false, bestFor: ["Photography", "Snorkeling"],   swimDepth: "Moderate", nearbyFood: false },
  { name: "Fyropotamos",         slug: "fyropotamos",         accessType: "road", facilities: ["sunbeds"],           sandType: "Sand",          shade: false, bestFor: ["Families", "Relaxation"],      swimDepth: "Shallow",  nearbyFood: false },
  { name: "Tsigrado",            slug: "tsigrado",            accessType: "road", facilities: ["parking"],           sandType: "Sand",          shade: true,  bestFor: ["Adventure", "Snorkeling"],     swimDepth: "Moderate", nearbyFood: false },
  { name: "Fyriplaka",           slug: "fyriplaka",           accessType: "road", facilities: ["sunbeds", "parking"],sandType: "Sand",          shade: false, bestFor: ["Families", "Swimming"],        swimDepth: "Shallow",  nearbyFood: true  },
  { name: "Paleochori",          slug: "paleochori",          accessType: "road", facilities: ["sunbeds", "parking"],sandType: "Sand",          shade: false, bestFor: ["Families", "Relaxation"],      swimDepth: "Shallow",  nearbyFood: true  },
  { name: "Provatas",            slug: "provatas",            accessType: "road", facilities: ["sunbeds", "parking"],sandType: "Sand",          shade: false, bestFor: ["Families", "Swimming"],        swimDepth: "Shallow",  nearbyFood: true  },
  { name: "Papafragas",          slug: "papafragas",          accessType: "road", facilities: [],                   sandType: "Volcanic rock", shade: true,  bestFor: ["Swimming", "Exploring"],       swimDepth: "Deep",     nearbyFood: false },
  { name: "Kleftiko",            slug: "kleftiko",            accessType: "boat", facilities: [],                   sandType: "Volcanic rock", shade: true,  bestFor: ["Snorkeling", "Photography"],   swimDepth: "Deep",     nearbyFood: false },
  { name: "Agia Kiriaki",        slug: "agia-kiriaki",        accessType: "road", facilities: ["sunbeds", "parking"],sandType: "Sand",          shade: false, bestFor: ["Families", "Relaxation"],      swimDepth: "Shallow",  nearbyFood: true  },
  { name: "Gerontas",            slug: "gerontas",            accessType: "road", facilities: [],                   sandType: "Pebble",        shade: false, bestFor: ["Photography", "Solitude"],     swimDepth: "Moderate", nearbyFood: false },
  { name: "Triades",             slug: "triades",             accessType: "road", facilities: [],                   sandType: "Sand",          shade: false, bestFor: ["Solitude", "Swimming"],        swimDepth: "Moderate", nearbyFood: false },
  { name: "Rivari",              slug: "rivari",              accessType: "road", facilities: [],                   sandType: "Sand",          shade: false, bestFor: ["Families", "Solitude"],        swimDepth: "Shallow",  nearbyFood: false },
  { name: "Sikia",         slug: "sikia",         accessType: "boat", facilities: [],                   sandType: "Volcanic rock", shade: true,  bestFor: ["Photography", "Snorkeling"],   swimDepth: "Moderate", nearbyFood: false },
  { name: "Plathiena",           slug: "plathiena",           accessType: "road", facilities: ["sunbeds", "parking"],sandType: "Sand",          shade: false, bestFor: ["Families", "Swimming"],        swimDepth: "Shallow",  nearbyFood: true  },
  { name: "Paralia theiorycheio",slug: "theiorycheia",        accessType: "road", facilities: [],                   sandType: "Pebble",        shade: false, bestFor: ["History", "Photography"],      swimDepth: "Moderate", nearbyFood: false },
  { name: "Achivadolimni",       slug: "achivadolimni",       accessType: "road", facilities: ["sunbeds", "parking"],sandType: "Sand",          shade: false, bestFor: ["Families", "Windsurfing"],     swimDepth: "Shallow",  nearbyFood: false },
  { name: "Agios Sostis",        slug: "agios-sostis",        accessType: "road", facilities: [],                   sandType: "Sand",          shade: false, bestFor: ["Families", "Solitude"],        swimDepth: "Shallow",  nearbyFood: false },
  { name: "Tria pigadia",        slug: "tria-pigadia",        accessType: "road", facilities: [],                   sandType: "Pebble",        shade: false, bestFor: ["Solitude", "Photography"],     swimDepth: "Moderate", nearbyFood: false },
  { name: "Kastanas",            slug: "kastanas",            accessType: "road", facilities: [],                   sandType: "Pebble",        shade: false, bestFor: ["Photography", "Solitude"],     swimDepth: "Moderate", nearbyFood: false },
  { name: "Pollonia beach",      slug: "pollonia-beach",      accessType: "road", facilities: ["parking"],           sandType: "Sand",          shade: false, bestFor: ["Families", "Relaxation"],      swimDepth: "Shallow",  nearbyFood: true,  cid: "ChIJeyxG4KfgmBQR3Z88FnBkAow" },
  { name: "Mandrakia",           slug: "mandrakia",           accessType: "road", facilities: ["parking"],           sandType: "Village waterfront", shade: false, bestFor: ["Photography", "Swimming"],     swimDepth: "Moderate", nearbyFood: true  },
  { name: "Aggathia",            slug: "aggathia",            accessType: "road", facilities: ["parking"],           sandType: "Pebble",        shade: false, bestFor: ["Solitude", "Swimming"],        swimDepth: "Moderate", nearbyFood: false },
  { name: "Ammoudaraki beach",   slug: "ammoudaraki-beach",   accessType: "road", facilities: [],                   sandType: "Sand",          shade: false, bestFor: ["Solitude", "Relaxation"],      swimDepth: "Moderate", nearbyFood: false },
  { name: "Kalamos beach",       slug: "kalamos",             accessType: "road", facilities: [],                   sandType: "Sand",          shade: false, bestFor: ["Swimming", "Photography"],     swimDepth: "Deep",     nearbyFood: false },
  { name: "Agios Ioannis beach", slug: "agios-ioannis-beach", accessType: "road", facilities: ["parking"],           sandType: "Sand",          shade: false, bestFor: ["Solitude", "Sunsets"],         swimDepth: "Moderate", nearbyFood: false },
  { name: "Paralia Kipos",       slug: "kipos-beach",         accessType: "road", facilities: [],                   sandType: "Pebble",        shade: false, bestFor: ["Relaxation", "Families"],      swimDepth: "Shallow",  nearbyFood: true,  cid: "ChIJW_iGVM0mmRQRETJ2dKCY_TI" },
  { name: "Deep blue beach",     slug: "deep-blue-beach",     accessType: "road", facilities: [],                   sandType: "Volcanic rock", shade: false, bestFor: ["Snorkeling", "Solitude"],      swimDepth: "Deep",     nearbyFood: false },
  { name: "Psathi beach",        slug: "psathi-beach",        accessType: "road", facilities: [],                   sandType: "Sand",          shade: false, bestFor: ["Relaxation", "Swimming"],      swimDepth: "Shallow",  nearbyFood: false, cid: "ChIJVw0Mz8gmmRQRYzwEn6RQcHI" },
  { name: "Kolympionas beach",   slug: "kolympionas-beach",   accessType: "road", facilities: [],                   sandType: "Pebble",        shade: false, bestFor: ["Solitude", "Nature"],          swimDepth: "Moderate", nearbyFood: false, cid: "ChIJSXzY4mTgmBQRzOBvpPa_C9s" },
  { name: "Voudia beach",        slug: "voudia-beach",        accessType: "road", facilities: ["parking"],           sandType: "Pebble",        shade: false, bestFor: ["History", "Photography"],      swimDepth: "Moderate", nearbyFood: false },
  { name: "Pachaina beach",      slug: "pachaina-beach",      accessType: "road", facilities: ["parking"],           sandType: "Sand",          shade: false, bestFor: ["Photography", "Relaxation"],   swimDepth: "Moderate", nearbyFood: false },
  { name: "Alogomantra beach",   slug: "alogomantra-beach",   accessType: "road", facilities: ["parking"],           sandType: "Pebble",        shade: true,  bestFor: ["Swimming", "Snorkeling"],      swimDepth: "Moderate", nearbyFood: false },
  { name: "Mytakas beach",       slug: "mytakas-beach",       accessType: "road", facilities: ["sunbeds", "parking"],sandType: "Pebble",        shade: false, bestFor: ["Photography", "Relaxation"],   swimDepth: "Shallow",  nearbyFood: false, cid: "ChIJH4sPfgDfmBQRK7u3niaeD6s" },
  { name: "Nerodafni beach",     slug: "nerodafni-beach",     accessType: "road", facilities: ["parking"],           sandType: "Pebble",        shade: false, bestFor: ["Solitude", "Relaxation"],      swimDepth: "Moderate", nearbyFood: false },
  { name: "Klima",         slug: "klima",               accessType: "road", facilities: ["parking"],           sandType: "Village waterfront", shade: false, bestFor: ["Photography", "Culture"],      swimDepth: "Moderate", nearbyFood: true  },
  { name: "Papikinou beach",     slug: "papikinou-beach",     accessType: "road", facilities: ["sunbeds", "parking"],sandType: "Sand",          shade: true,  bestFor: ["Families", "Relaxation"],      swimDepth: "Shallow",  nearbyFood: true  },
  { name: "Agios Dimitrios beach",slug: "agios-dimitrios-beach",accessType: "boat",facilities: [],                  sandType: "Sand",          shade: false, bestFor: ["Solitude", "Families"],        swimDepth: "Shallow",  nearbyFood: false },
];
...
async function fetchPlace(query) {
  const res = await fetch("https://places.googleapis.com/v1/places:searchText", {
    ...
    headers: {
      ...
      "X-Goog-FieldMask":
        "places.id,places.displayName,places.formattedAddress,places.nationalPhoneNumber,places.location,places.rating,places.priceLevel,places.regularOpeningHours,places.websiteUri",
    },
...
async function fetchPlaceByCid(placeId) {
  ...
  const fieldMask = "id,displayName,formattedAddress,nationalPhoneNumber,location,rating,priceLevel,regularOpeningHours,websiteUri";
  ...
  for (const beach of seedBeaches) {
    try {
      ...
      finalData.push({
        ...
        swimDepth:     beach.swimDepth,
        nearbyFood:    beach.nearbyFood,
      });
      console.log(`  ✅ ${place.displayName?.text}`);
